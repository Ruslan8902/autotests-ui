...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.create_course_estimated_time_input = Input(page,'create-course-form-estimated-time-input', 'Course estimated time input')
        self.create_course_description_textarea = Textarea(page,'create-course-form-description-input', 'Course description input')
